...
export const ProductCreateModal = ({categoryOptions, isOpen, onClose, onProductCreated}: ProductCreateModalProps) => {
    ...
    const {
        ...
        toggleCategory,
        values,
    } = useCreateProductForm(onProductCreated, onClose);
                    ...
                    <div className={CREATE_PRODUCT_MODAL_CLASS_NAMES.label}>
                        ...
                        {values.image.length > 0 && (
                            <span className={CREATE_PRODUCT_MODAL_CLASS_NAMES.selectedImages}>
                                <span>Вибрано фото: {values.image.length}</span>
