...
export const HEADER_NAV_CLASS_NAMES = {
    ...
    link: "relative z-10 flex h-[52px] min-w-0 flex-1 flex-col items-center justify-center gap-0.5 rounded-[1.5rem] px-2 text-[11px] text-[#8f8780] transition-colors duration-300 hover:text-[#17150c]",
    activeLink: "relative z-10 flex h-[52px] min-w-0 flex-1 flex-col items-center justify-center gap-0.5 rounded-[1.5rem] px-2 text-[11px] text-[#1c1c1e] transition-colors duration-300",
    ...
    mobileNav: "fixed bottom-6 left-1/2 z-40 grid h-16 w-[min(calc(100vw-2rem),28rem)] -translate-x-1/2 grid-cols-3 items-center gap-1 overflow-hidden rounded-[2rem] border border-white/55 bg-white/50 p-1.5 shadow-[0_12px_30px_rgba(23,21,12,0.12),inset_0_1px_0_rgba(255,255,255,0.78)] backdrop-blur-2xl",
